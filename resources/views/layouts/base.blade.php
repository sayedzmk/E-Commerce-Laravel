                            ...
                            <div class="container">
                                <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                    <li class="menu-item home-icon">
                                        <a href="{{ route('home.page') }}" class="link-term mercado-item-title"><i
                                    ...
                                    <li class="menu-item">
                                        <a href="{{ route('shop.page') }}" class="link-term mercado-item-title">Shop</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="{{ route('cart.page') }}" class="link-term mercado-item-title">Cart</a>
                                    </li>
                                    <li class="menu-item">
