                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <a  class="btn add-to-cart"  wire:click.prevent="store({{$item->id}},
                                        '{{$item->name}}',{{$item->regular_price}})">Add To Cart</a>
                                        {{-- <button type="button" wire:click="{{$item->id}},
                                            '{{$item->name}}',{{$item->regular_price}})">Add To Cart </button> --}}
                                </div>
                            </div>
                        </li>
                        @endforeach
                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="widget-banner">
                            <figure><img src="{{asset('assets/images/size-banner-wid')}}get.jpg" width="270" height="331" alt=""></figure>
                        </div>
                    </div>
                </div><!-- Size -->
