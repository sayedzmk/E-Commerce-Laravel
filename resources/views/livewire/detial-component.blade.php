            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                            <ul class="slides">
                                ...
                                <li data-thumb="{{ asset('assets/images/products') }}/{{ $deail->image }}">
                                    <img src="{{ asset('assets/images/products') }}/{{ $deail->image }}"
                    ...
                    <div class="detail-info">
                        ...
                        <h2 class="product-name">{{ $deail->name }}</h2>
                        ...
                        <div class="wrap-price"><span class="product-price"></span>${{ $deail->regular_price }}</div>
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b>{{ $deail->stock_status }}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                        ...
                        <div class="wrap-butons">
                            <a href="#" class="btn add-to-cart"wire:click.prevent="store({{$deail->id}},
                                '{{$deail->name}}','{{$deail->regular_price}}')">Add to Cart</a>
                            <div class="wrap-btn">
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            <a href="{{ route('product.details', ['slug' => $pop_product->slug]) }}"
                                                title="{{ $pop_product->name }}"><span>{{ $pop_product->name }}</span></a>
                ...
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            @foreach ($related as $relt_product)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details', ['slug' => $pop_product->slug]) }}" title="{{ $relt_product->name }}">
                                            <figure><img src="{{ asset('assets/images/products') }}/{{ $relt_product->image }}"
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details', ['slug' => $pop_product->slug]) }}" class="product-name"><span>{{ $relt_product->name }}</span></a>
                                        <div class="wrap-price"><span class="product-price">${{ $relt_product->regular_price }}</span></div>
                                    </div>
                                </div>
                            @endforeach
